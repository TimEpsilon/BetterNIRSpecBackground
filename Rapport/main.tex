...
\begin{wrapfigure}{l}{0.4\linewidth}
  \centering
  \includegraphics[scale=0.35]{assets/idw_interpolation.png}
...
Une autre stratégie consiste en l'ajustement d'un polynôme en 2 dimensions sur chaque bande de fond. Cependant, la 
